...
curl -L https://nodejs.org/dist/v18.18.0/node-v18.18.0-darwin-arm64.tar.gz -o node.tar.gz\
...
curl -L https://github.com/neovim/neovim/releases/download/v0.9.4/nvim-macos.tar.gz -o nvim-macos.tar.gz \
	&& tar xzvf nvim-macos.tar.gz > /dev/null 2>&1 \
...
curl -L -o glow.tar.gz https://github.com/charmbracelet/glow/releases/download/v1.5.1/glow_Darwin_arm64.tar.gz \
...
curl -L -o rg.tar.gz https://github.com/BurntSushi/ripgrep/releases/download/14.0.2/ripgrep-14.0.2-aarch64-apple-darwin.tar.gz \
